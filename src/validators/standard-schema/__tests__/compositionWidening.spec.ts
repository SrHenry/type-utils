...
const zodStringOptional = mockStdSchema(
    'zod',
...
describe('asEnum — toStandardSchema()', () => {
    it('produces a valid StandardSchemaV1', () => {
        ...
        const result = stdSchema['~standard'].validate('a') as Exclude<
            ReturnType<StandardSchemaV1<any>['~standard']['validate']>,
            Promise<any>
        >
