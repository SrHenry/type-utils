...
describe('number', () => {
    ...
    it('should return false if value does not follow defined rules', () => {
        ...
        expect(number().nonZero()(0)).toBe(false)
        expect(number().nonZero()(-0)).toBe(false)
        expect(number().nonZero()(0.0)).toBe(false)
        expect(number().nonZero()(-0.0)).toBe(false)
        expect(number().nonZero()(0.0)).toBe(false)
        expect(number().nonZero()(-0.0)).toBe(false)
    })
    ...
    it('should return false if value does not follow defined rules when optional schema', () => {
        ...
        expect(number().optional().nonZero()(0)).toBe(false)
        expect(number().optional().nonZero()(-0)).toBe(false)
        expect(number().optional().nonZero()(0.0)).toBe(false)
        expect(number().optional().nonZero()(-0.0)).toBe(false)
        expect(number().optional().nonZero()(0.0)).toBe(false)
        expect(number().optional().nonZero()(-0.0)).toBe(false)
    })
