...
export namespace CurryingTools {
  ...
  export type CurriedFirstArg<TFunc extends Func<any[], any>, TArgs extends any[]> = TupleTail<
    Parameters<TFunc>,
    TArgs['length']
  > extends [infer A, ...any[]]
    ? A
  ...
  export type CurriedReturn<TFunc extends Func<any[], any>, TArgs extends any[]> = CurriedFunc<TFunc, TArgs> extends (arg: any) => infer R
    ? R
    : ReturnType<TFunc>
}
